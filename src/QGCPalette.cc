...
void QGCPalette::_buildMap()
{
    ...
    DECLARE_QGC_COLOR(window,               "#ffffff", "#ffffff", "#111111", "#111111")
    DECLARE_QGC_COLOR(windowShadeLight,     "#909090", "#828282", "#707070", "#626262")
    DECLARE_QGC_COLOR(windowShade,          "#111111", "#111111", "#111111", "#111111")
    ...
    DECLARE_QGC_COLOR(buttonHighlight,      "#e4e4e4", "#946120", "#444444", "#444444")
    ...
    DECLARE_QGC_COLOR(toolStripHoverColor,  "#585858", "#9D9D9D", "#111111", "#444444")
